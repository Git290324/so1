...
SKILLS={
	--Îå¶¾
	dusha_zhang={ --¶¾É°ÕÆ doc sa chuong
		poisondamage_v={{{1,10},{2,15}},{{1,60},{20,60}},{{1,10},{20,10}}},
	...
	youming_kulou={ --ÓÄÚ¤÷¼÷Ãu minh kho lau
		poisondamage_v={{{1,20},{2,30}},{{1,60},{20,60}},{{1,10},{20,10}}},
	...
	tiangang_disha={ --Ììî¸µØÉ± thien cuong dia sat
		seriesdamage_p={{{1,10},{20,50},{21,52}}},
		poisondamage_v={{{1,50},{2,60}},{{1,60},{20,60}},{{1,10},{20,10}}},
		addskilldamage1={
			[1]={{1,354},{2,354}},
			[3]={{1,2},{20,181}}
		},
	...
	wudu_qijing={ --Îå¶¾Ææ¾­
		addpoisonmagic_v={{{1,5},{30,45}},{{1,-1},{20,-1}},{{1,11},{2,11}}},
		addpoisondamage_v={{{1,5},{30,45}},{{1,-1},{20,-1}},{{1,11},{2,11}}},
		--addpoisondamage_v={{{1,5},{30,100}},{{1,-1},{20,-1}},{{1,11},{2,11}}},
		poisonenhance_p={{{1,12},{30,45},{33,45},{35,45},{38,45}},{{1,-1},{2,-1}}},
	...
	yinfeng_shigu={ --Òõ·çÊ´¹Ç am phong thuc cot
		seriesdamage_p={{{1,20},{15,20},{20,60},{21,62}}},
		poisondamage_v={{{1,20},{15,50},{20,75}},{{1,60},{20,60}},{{1,10},{20,10}}},
