nTask_ItemScript_HangNgaLenhBai = 4959   		--Task ID -> Sè l­îng mµ ngõ¬i ch¬i nép long den kq
nLimit_HangNgaLenhBai = 3

ITEM_HANGNGA_LENHBAI	= {szName = "H»ng Nga LÖnh Bµi 2023", tbProp = {6,1,4403,1,0,0}}
...
tbAward_HangNgaLenhBai  = {
	{szName = "§iÓm kinh nghiÖm", nExp_tl=3e6, nRate=50},
	{szName="Thó c­ìi L¹c §µ", tbProp={0,10,23,1,0,0}, nExpiredTime= 43200, nCount = 1, nRate=50},
