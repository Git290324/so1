...
function main()
	dofile("script/global/dockaka/mapvip2.lua");		
...
-- end
				...
				local tbOpt =
	{
		...
		-- {"NhËn hç trî t©n thñ", hotrotanthune},
		 ...
		 {"®i s¨n boss map tuyÖt t×nh cèc", gotobaitrainboss},
...
function gotobaitrain()
	    ...
	    NewWorld(969, 1581, 3187)
        SetFightState(1)

end
function gotobaitrainboss()

	    NewWorld(969, 1583, 3572)
        SetFightState(1)
