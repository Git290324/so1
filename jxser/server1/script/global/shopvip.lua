...
function main()
	...
	tinsert(bilTbOp, "Mua huyÒn tinh cÊp 1 (30 V¹n)/cap1")
	tinsert(bilTbOp, "Mua huyÒn tinh cÊp 10 (2000 V¹n)/cap10")
	tinsert(bilTbOp, "Mua tÝn vËt m«n ph¸i (2000 V¹n)/tinvat")
...
function cap1()
	if (GetCash() <= 300000) then
		Talk(1, "", "Ph¶i ca ®ñ 30 v¹n míi ca thÓ mua.")
		return
	end
	Pay(300000)
	local tbItem = {szName="Mua huyÒn tinh cÊp 1", tbProp={6,1,147,1,0,0}, nBindState=-0,nExpiredTime = 0}
	tbAwardTemplet:GiveAwardByList(tbItem, "Mua huyÒn tinh cÊp 1", 1)
...
function cap10()
	...
	Pay(20000000)
	local tbItem = {szName="Mua huyÒn tinh cÊp 10", tbProp={6,1,147,10,10,10}, nBindState=-0,nExpiredTime = 0}
	tbAwardTemplet:GiveAwardByList(tbItem, "Mua huyÒn tinh cÊp 10", 1)
...
function tinvat()
	...
	Pay(20000000)
	local tbItem = {szName="Mua tÝn vËt m«n ph¸i", tbProp={6,1,1670,1,0,0}, nBindState=-0,nExpiredTime = 0}
	tbAwardTemplet:GiveAwardByList(tbItem, "Mua tÝn vËt m«n ph¸i", 1)
