...
function Task_NewVersionAward()
	...
	-- if (nNum - nCancelNum) == 9 then
		-- Msg2Player("<color=yellow>H«m nay hoµn thµnh nhiÖm vô D· TÈu lÇn thø 10, nhËn ®­îc kinh nghiÖm thªm!");
		-- tbAwardTemplet:GiveAwardByList({nExp = 1000000}, "PhÇn th­ëng kinh nghiÖm hoµn thµnh nhiÖm vô D· TÈu h»ng ngµy")
	-- end

	-- if (nNum - nCancelNum) == 19 then
		-- Msg2Player("<color=yellow>H«m nay hoµn thµnh nhiÖm vô D· TÈu lÇn thø 30, nhËn ®­îc kinh nghiÖm thªm!");
		-- tbAwardTemplet:GiveAwardByList({nExp = 2000000}, "PhÇn th­ëng kinh nghiÖm hoµn thµnh nhiÖm vô D· TÈu h»ng ngµy")
	-- end

	-- if (nNum - nCancelNum) == 29 then
	if nNum == 29 then
		-- Msg2Player("<color=yellow>H«m nay hoµn thµnh nhiÖm vô D· TÈu lÇn thø 30, nhËn ®­îc kinh nghiÖm thªm!");
	...
	-- if (nNum - nCancelNum) == 39 then
		if nNum == 39 then
		Msg2Player("<color=yellow>H«m nay hoµn thµnh liªn tôc nhiÖm vô D· TÈu lÇn thø 40, nhËn ®­îc kinh nghiÖm thªm!");
		AddItem(6,1,125,1,0,0);
		-- Earn(100000)
		-- tbAwardTemplet:GiveAwardByList({nExp = 5000000}, "PhÇn th­ëng kinh nghiÖm khi hoµn thµnh nhiÖm vô D· TÈu h»ng ngµy")
	end	
...
if(GetLevel()<90)then
Talk(1,"","CÊp 90 míi ®­îc nhËn nhiÖm vô d· tÈu");
return
end
...
Say(myTitleText,
	...
	"Ta muèn dïng 30 v¹n ®Ó hoµn thµnh nhiÖm vô nµy ngay/hoanthanh",
...
Say("<color=green>Ng­¬i kh«ng cã <color=red>30 v¹n<color> !") 
return
end 
Pay(tienvan)
		Task_AwardRecord()
