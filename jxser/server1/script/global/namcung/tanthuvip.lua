...
local Index = AddGoldItem(0,5290) ITEM_SetExpiredTime(Index,24*60*7) SyncItem(Index) SetItemBindState(Index, -2) -- an
...
local Index = AddItem(6,1,438,1,0,0) ITEM_SetExpiredTime(Index,24*60*7) SyncItem(Index) SetItemBindState(Index, -2)	-- tho dia phu
local Index = AddItem(6,1,1266,1,0,0) ITEM_SetExpiredTime(Index,24*60*7) SyncItem(Index) SetItemBindState(Index, -2) -- than hanh phu
