...
if GetLevel() >= 1 or GetTask(197) >= 1 then
if GetTaskTemp(93) ~= 1 then
if GetTaskTemp(92) == 0 then
if GetTask(93) == 0 then
        Say("<color=cyan>VLTB<color> : HÖ thèng chèng <color=red> Hack nh©n vËt <color> ®­a vµo ho¹t ®éng ! ",1,"KiÓm tra nh©n vËt ./anti")

else
        Say("<color=cyan>VLTB<color> : §· kiÓm tra xong , mêi b¹n vµo game ",1,"Tham gia vµo game./anti1")
...
SetFightState(0)
        ...
        Say("<color=cyan> JX Tranh Ba <color>: Chµo mõng b¹n tham gia server JX Tranh Ba>",1,"                   Tham Gia Game./check")
        else
            SetTask(93,0)
            SetTask(94,0)
            KickOutSelf()
