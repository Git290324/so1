	...
	if (myGiveAwardType==1) then -- ½±ÀøÀàĞÍÊÇÆÕÍ¨ÈÎÎñ½±Àø
		...
		for i=1,3 do -- Ñ­»·Ñ¡³öÈı¸ö½±ÀøÖÖÀà
			...
			if (myAwardType==1) then -- Èç¹û½±ÀøÀàĞÍÊÇÇ®
				...
				myMainValue = floor((myMainValue * 0.05 * 1.15) * (C_Random(60,100) * 0.005)) + myTaskValue1 -- ¼ÆËãºóµÃ³öµÄÊµ¼Ê½ğÇ®Á¿tien van
			...
			elseif (myAwardType==2) then -- Èç¹û½±ÀøµÄÊÇ¾­Ñé
				...
				myMainValue = floor((myMainValue * 0.36) * (C_Random(80,120) * 0.01)) -- ¼ÆËãºóµÃ³öµÄÊµ¼Ê¾­ÑéÖµÁ¿kinh nghiem
