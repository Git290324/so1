...
ContentList = {
	...
	"<#>  v­ît ¶i - ®¬n ®Êu ( s¬ cÊp )/want_playboat_socap_dondau", --32
    "<#>  v­ît ¶i - ®¬n ®Êu ( cao cÊp )/want_playboat_caocap_dondau", --33
    "<#>  v­ît ¶i - ®éi ( s¬ cÊp)/want_playboat_socap_todoi", --34
    "<#>  v­ît ¶i - ®éi ( cao cÊp )/want_playboat_caocap_todoi", --35
...
--Thªm dßng kiÓm tra ®iÒu kiÖn tham gia khiªu chiÕn cña tæ ®éi - Modified by DinhHQ - 20110504
	...
	Describe(DescLink_NieShiChen..ContentList[26], 5, ContentList[32],ContentList[33],ContentList[34],ContentList[35]),ContentList[11]);
end
