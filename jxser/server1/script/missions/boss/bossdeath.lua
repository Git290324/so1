...
local tbVnNewItemDropAward = {
	...
	-- {{szName = "random an bang dinh quoc",tbProp = {0,random(159,167)},nCount = 1, 					nRate = 0.3,nQuality = 1, },},
	
	{{szName = "Hi÷p CËt Thi’t Huy’t Sam",tbProp = {0,186},nCount = 1, 					nRate = 5,nQuality = 1},},
	{{szName = "Hi÷p CËt ßa T◊nh Hoµn",tbProp = {0,187},nCount = 1, 					nRate = 5,nQuality = 1 },},
	{{szName = "Hi÷p CËt ßan T©m GiÌi",tbProp = {0,188},nCount = 1, 					nRate = 5,nQuality = 1},},
	{{szName = "Hi÷p CËt T◊nh ˝ K’t",tbProp = {0,189},nCount = 1, 						nRate = 5,nQuality = 1 },},
	{{szName = "Nhu T◊nh C©n QuËc Ngh÷ Th≠Íng",tbProp = {0,190},nCount = 1,					nRate = 5,nQuality = 1},},
	{{szName = "Nhu T◊nh ThÙc N˜ Hπng Li™n",tbProp = {0,191},nCount = 1, 					nRate = 5,nQuality = 1 },},
	{{szName = "Nhu T◊nh PhÙng Nghi Gi Ìi Chÿ",tbProp = {0,192},nCount = 1, 					nRate = 5,nQuality = 1 },},
	{{szName = "Nhu T◊nh Tu÷ T©m Ng‰c BÈi",tbProp = {0,193},nCount = 1, 					nRate = 5,nQuality = 1 },},

	{{szName = "ßﬁnh QuËc",tbProp = {0,random(159,163)},nCount = 1,					nRate = 5,nQuality = 1 },},
	{{szName = "an bang",tbProp = {6,1,random(4383,4385),1,0,0},nCount = random(2,5),					nRate = 5 },},
