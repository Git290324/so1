...
{"Thanh TuyÖt S­ Th¸i", 743, 95, 2, {"Sa M¹c s¬n  ®éng 1","Sa M¹c s¬n  ®éng 3","city"}},
{"Hµn Ngu Dèt", 748, 95, 1, {"Phong L¨ng ®é","Kho¶ Lang ®éng","city"}},					
...
function TaskShedule()
	-- ÉèÖÃ·½°¸Ãû³Æ
	TaskName( "BOSS HOANG KIM XUAT HIEN VAO 08:00" );
	TaskInterval( 1440 );
	TaskTime( 08, 0 );
	TaskCountLimit( 0 );
	-- Êä³öÆô¶¯ÏûÏ¢
	OutputMsg("=====> Boss Hoang Kim Xuat Hien Vao Luc :  08:00" );
end
